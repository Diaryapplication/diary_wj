...
import com.example.diaryapplication.db.ScheduleDatabase;
...
/*
    ...
    public void monthlyClick(View view) {
        Intent intent_cal = new Intent(getApplicationContext(), MonthlyActivity.class);
        startActivity(intent_cal);
    }

    public void weeklyClick(View view) {
        Intent intent_week = new Intent(getApplicationContext(), WeeklyActivity.class);
